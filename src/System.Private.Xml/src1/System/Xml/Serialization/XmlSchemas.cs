...
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlSchemaDuplicateNamespace, ns));
//            }
//        }
...
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlInternalErrorDetails, "XmlSchemas.Find: Invalid object type " + type.FullName));
//            }
//#endif
...
//                        {
//                            throw new InvalidOperationException(SRFormat.Format(SR.XmlSchemaIncludeLocation, this.GetType().Name, external.SchemaLocation));
//                        }
//                    }
//                    else
//                    {
...
//            if (o is XmlSchemaNotation)
//            {
//                item = SRFormat.Format(SR.XmlSchemaNamedItem, ns, "notation", ((XmlSchemaNotation)o).Name, details);
//            }
//            else if (o is XmlSchemaGroup)
//            {
//                item = SRFormat.Format(SR.XmlSchemaNamedItem, ns, "group", ((XmlSchemaGroup)o).Name, details);
//            }
//            else if (o is XmlSchemaElement)
//            {
//                XmlSchemaElement e = ((XmlSchemaElement)o);
...
//                    item = SRFormat.Format(SR.XmlSchemaElementReference, e.RefName.ToString(), parentName.Name, parentName.Namespace);
//                }
//                else
//                {
//                    item = SRFormat.Format(SR.XmlSchemaNamedItem, ns, "element", e.Name, details);
//                }
//            }
//            else if (o is XmlSchemaType)
//            {
//                item = SRFormat.Format(SR.XmlSchemaNamedItem, ns, o.GetType() == typeof(XmlSchemaSimpleType) ? "simpleType" : "complexType", ((XmlSchemaType)o).Name, null);
//            }
//            else if (o is XmlSchemaAttributeGroup)
//            {
//                item = SRFormat.Format(SR.XmlSchemaNamedItem, ns, "attributeGroup", ((XmlSchemaAttributeGroup)o).Name, details);
//            }
//            else if (o is XmlSchemaAttribute)
//            {
...
//                    return SRFormat.Format(SR.XmlSchemaAttributeReference, a.RefName.ToString(), parentName.Name, parentName.Namespace);
//                }
//                else
//                {
//                    item = SRFormat.Format(SR.XmlSchemaNamedItem, ns, "attribute", a.Name, details);
//                }
//            }
...
//                item = SRFormat.Format(SR.XmlSchemaContentDef, parentName.Name, parentName.Namespace, null);
//            }
...
//                item = SRFormat.Format(SR.XmlSchemaItem, ns, itemType, details);
//            }
//            else if (o is XmlSchema)
//            {
//                item = SRFormat.Format(SR.XmlSchema, ns, details);
//            }
//            else
//            {
//                item = SRFormat.Format(SR.XmlSchemaNamedItem, ns, o.GetType().Name, null, details);
//            }
...
//        {
//            string err = SRFormat.Format(SR.XmlSerializableMergeItem, ns, GetSchemaItem(src, ns, null));
//            err += "\r\n" + Dump(src);
//            err += "\r\n" + Dump(dest);
//            return err;
//        }
...
//                    }
//                }
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlSchemaSyntaxErrorDetails, ns, message, exception.LineNumber, exception.LinePosition), exception);
//            }
//        }
