...
namespace SGen.Xml.Serialization
{
    ...
    internal class XmlCustomFormatter
    {
        ...
        internal static string FromDefaultValue(object value, string formatter)
        {
            ...
            throw new Exception(SRFormat.Format(SR.XmlUnsupportedDefaultType, type.FullName));
        }
        ...
        internal static string FromEnum(long val, string[] vals, long[] ids, string typeName)
        {
                ...
                if (ids.Length != vals.Length) throw new InvalidOperationException(SRFormat.Format(SR.XmlInternalErrorDetails, "Invalid enum"));
#endif
            ...
            if (val != 0)
            {
                ...
                throw new InvalidOperationException(SRFormat.Format(SR.XmlUnknownConstant, originalValue, typeName == null ? "enum" : typeName));
            }
        ...
        internal static object ToDefaultValue(string value, string formatter)
        {
            ...
            throw new Exception(SRFormat.Format(SR.XmlUnsupportedDefaultValue, formatter));
        ...
        internal static long ToEnum(string val, Hashtable vals, string typeName, bool validate)
        {
            ...
            for (int i = 0; i < parts.Length; i++)
            {
                ...
                if (id != null)
                    ...
                    throw new InvalidOperationException(SRFormat.Format(SR.XmlUnknownConstant, parts[i], typeName));
            }
            return value;
        }
