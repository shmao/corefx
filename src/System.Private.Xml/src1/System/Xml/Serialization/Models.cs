        ...
        internal TypeModel GetTypeModel(Type type, bool directReference)
        {
            ...
            switch (typeDesc.Kind)
            {
                ...
                case TypeKind.Struct:
                    ...
                    break;
                default:
                    if (!typeDesc.IsSpecial) throw new NotSupportedException(SRFormat.Format(SR.XmlUnsupportedTypeKind, type.FullName));
    ...
    internal class StructModel : TypeModel
    {
        ...
        private void CheckSupportedMember(TypeDesc typeDesc, MemberInfo member, Type type)
        {
            ...
            if (typeDesc.IsUnsupported)
            {
                ...
                {
                    typeDesc.Exception = new NotSupportedException(SRFormat.Format(SR.XmlSerializerUnsupportedType, typeDesc.FullName));
                }
                throw new InvalidOperationException(SRFormat.Format(SR.XmlSerializerUnsupportedMember, member.DeclaringType.FullName + "." + member.Name, type.FullName), typeDesc.Exception);
            }
    ...
    internal class FieldModel
    {
        ...
        internal FieldModel(MemberInfo memberInfo, Type fieldType, TypeDesc fieldTypeDesc)
        {
            ...
            if (specifiedField != null)
            {
                ...
                {
                    throw new InvalidOperationException(SRFormat.Format(SR.XmlInvalidSpecifiedType, specifiedField.Name, specifiedField.FieldType.FullName, typeof(bool).FullName));
                }
            ...
            else
            {
                ...
                if (specifiedProperty != null)
                {
                    ...
                    {
                        throw new InvalidOperationException(SRFormat.Format(SR.XmlInvalidSpecifiedType, specifiedProperty.Name, specifiedProperty.PropertyType.FullName, typeof(bool).FullName));
                    }
                }
            }
