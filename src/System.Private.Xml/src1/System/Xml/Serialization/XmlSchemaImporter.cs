...
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlBadBaseElement, name.Name, name.Namespace, baseType.FullName));
//                }
//            }
...
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlBadBaseType, typeName.Name, typeName.Namespace, baseType.FullName));
//                }
//            }
...
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlElementHasNoName, parentType.Name, parentType.Namespace));
//            }
...
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlElementImportedTwice, element.Name, ns, mapping.GetType().Name, desiredMappingType.Name));
...
//                throw new NotSupportedException(SRFormat.Format(SR.XmlUnsupportedRedefine, type.Name, typeNs));
//            }
...
//                else
//                {
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlTypeUsedTwice, type.QualifiedName.Name, type.QualifiedName.Namespace));
//                }
//            }
...
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlIllegalOverride, type.Name, baseMember.Name, baseMember.TypeDesc.FullName, structMapping.Members[i].TypeDesc.FullName, declaringMapping.TypeDesc.FullName));
//            }
...
//                if (!allowDuplicates)
//                {
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlDuplicateElementInScope, element.Name, element.Namespace));
//                }
//                if (scopeElement.Mapping.TypeDesc != element.Mapping.TypeDesc)
//                {
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlDuplicateElementInScope1, element.Name, element.Namespace));
//                }
...
//            if (group == null)
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlMissingGroup, name.Name));
...
//            if (group == null)
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlMissingAttributeGroup, name.Name));
...
//                {
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlInvalidEncoding, name.ToString()));
//                }
//                else
//                {
//                    throw new InvalidOperationException(SRFormat.Format(SR.XmlMissingDataType, name.ToString()));
//                }
//            }
//        }
...
//            if (element == null)
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlMissingElement, name.ToString()));
//            return element;
//        }
...
//            if (attribute == null)
//                throw new InvalidOperationException(SRFormat.Format(SR.XmlMissingAttribute, name.Name));
