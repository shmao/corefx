        ...
        public void Serialize(XmlWriter xmlWriter, object o, XmlSerializerNamespaces namespaces, string encodingStyle, string id)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        throw new InvalidOperationException(SRFormat.Format(SR.Xml_MissingSerializationCodeException, this.rootType, typeof(XmlSerializer).Name));
                    }
                }
#endif
            }
        ...
        public object Deserialize(XmlReader xmlReader, string encodingStyle, XmlDeserializationEvents events)
        {
            ...
            catch (Exception e)
            {
                ...
                if (xmlReader is IXmlLineInfo)
                {
                    ...
                    throw new InvalidOperationException(SRFormat.Format(SR.XmlSerializeErrorDetails, lineInfo.LineNumber.ToString(CultureInfo.InvariantCulture), lineInfo.LinePosition.ToString(CultureInfo.InvariantCulture)), e);
                }
                else
                {
        ...
        private void SerializePrimitive(XmlWriter xmlWriter, object o, XmlSerializerNamespaces namespaces)
        {
            ...
            switch (_primitiveType.GetTypeCode())
            {
                ...
                default:
                    ...
                    {
                        throw new InvalidOperationException(SRFormat.Format(SR.XmlUnxpectedType, _primitiveType.FullName));
                    }
                    break;
            }
        }
