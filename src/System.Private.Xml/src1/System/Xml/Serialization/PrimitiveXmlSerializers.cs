...
{
    internal class XmlSerializationPrimitiveWriter : SGen.Xml.Serialization.XmlSerializationWriter
    {
    ...
    internal class XmlSerializationPrimitiveReader : SGen.Xml.Serialization.XmlSerializationReader
    {
