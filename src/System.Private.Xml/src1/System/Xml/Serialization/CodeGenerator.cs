    ...
    internal class CodeGenerator
    {
            ...
            else
            {
                switch (valueType.GetTypeCode())
                {
                    ...
                    default:
                        ...
                        throw new NotSupportedException(SRFormat.Format(SR.UnknownConstantType, valueType.AssemblyQualifiedName));
                }
            }
        }
        ...
        internal void Ldelem(Type arrayElementType)
        {
            ...
            else
            {
                ...
                if (opCode.Equals(OpCodes.Nop))
                    throw new InvalidOperationException(SRFormat.Format(SR.ArrayTypeIsNotSupported, arrayElementType.AssemblyQualifiedName));
                _ilGen.Emit(opCode);
            }
        }
